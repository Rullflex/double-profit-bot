...
Многофункциональный Telegram-бот, написанный на TypeScript (Node.js), с интеграцией Google Sheets и поддержкой внутренних/внешних ботов для команды Double Profit.
