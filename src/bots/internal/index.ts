...
import { handleDailyReport, handleElamaAuto, handleElamaInvoice, handleElamaManual, handleReset, handleStart } from '@/handlers/command'
...
export async function registerInternalBot(app: AppContext) {
  ...
  bot.command(InternalCommand.ELAMA_INVOICE, handleElamaInvoice.bind(null, app))
